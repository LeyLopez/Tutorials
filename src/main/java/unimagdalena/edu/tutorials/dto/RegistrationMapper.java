...
public interface RegistrationMapper {
    ...
    @Mapping(source = "student.userId", target = "student")
    ...
    @Mapping(source = "mentory", target = "mentory", qualifiedByName = "IdToMentory")
    @Mapping(source = "student", target = "student", qualifiedByName = "IdToStudent")
